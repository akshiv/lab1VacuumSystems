...
t = title('Relative Partial Pressure Vs Atomic Mass of Gas Species in the Process Chamber with constant $N_{2}$ Flow');
t.Color = 'k';
t.Interpreter = 'LaTeX';
t.FontSize = 24;
...
t = title('Relative PP Vs AM in the Process Chamber with constant $N_{2}$ Flow, Background Subtracted');
t.Color = 'k';
t.Interpreter = 'LaTeX';
t.FontSize = 24;
